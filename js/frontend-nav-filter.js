...
(function(){
  ...
  function applyNavFilter(){
    ...
    // 首页卡片/按钮：多种方式匹配模块
    var cardSelectors = ['.card', '.grid-item', '.feature-card', '.quick-card', '.nav-card', '.home-card', '.module-card', '.service-card', '.icon-card', '.func-card', '.menu-card', '.service-grid > div', '.quick-links > div', '.home-modules > div', '.module-list > div', '.grid > div', '.flex > div', 'main > div > div'];
    var allCards = [];
